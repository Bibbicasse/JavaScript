...
function porteeNew() {
    ...
    if (true) {
        ...
        document.getElementById('p1').innerHTML = 'xLet dans le if = ' + xLet ;
        document.getElementById('p2').innerHTML = 'yVar dans le if = ' + yVar ;
        //console.log(xLet);
    }//fin du if true
    document.getElementById('p3').innerHTML = "La Variable let 'xLet' hors du if = " + xLet;
    document.getElementById('p4').innerHTML = "La Variable let 'xVar' hors du if = " + yVar;
